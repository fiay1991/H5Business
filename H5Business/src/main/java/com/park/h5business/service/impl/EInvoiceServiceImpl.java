...
import com.park.h5business.config.EInvoiceConfig;
import com.park.h5business.dao.OrderPayRecordDao;
import com.park.h5business.profile.URLProfile;
import com.park.h5business.response.EIPublicResponse;
import com.park.h5business.service.EInvoiceService;
import com.park.h5business.tools.BackResultTools;
import com.park.h5business.tools.Base64Tools;
...
public class EInvoiceServiceImpl implements EInvoiceService {
	...
	public String getEInvioceUrl(String tradeNo){
		...
		String result=HttpJsonTools.HttpClientPost(requestUrl, sparams, headers);
		return result;
