...
public class URLProfile {
	...
	private String NOPLATEREDIRURL;
	...
	public String getNOPLATEREDIRURL() {
		return NOPLATEREDIRURL;
	}
	public void setNOPLATEREDIRURL(String nOPLATEREDIRURL) {
		NOPLATEREDIRURL = nOPLATEREDIRURL;
	}
