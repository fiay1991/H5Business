...
public class OrderEnterDomain {
    ...
    public String toString() {
        return "OrderEnterDomain [id=" + id + ", orderNum=" + orderNum + ", parkId=" + parkId + ", plateNumber="
                + plateNumber + ", cardId=" + cardId + ", ticketId=" + ticketId + ", carType=" + carType
                + ", enterTime=" + enterTime + ", costBefore=" + costBefore + ", costAfter=" + costAfter
                + ", discountAmount=" + discountAmount + ", prepayAmount=" + prepayAmount + ", prepayTime=" + prepayTime
                + ", type=" + type + ", carDesc=" + carDesc + ", localOrderId=" + localOrderId + ", createTime="
